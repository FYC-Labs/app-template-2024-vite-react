...
const headers = {
  reg: [
    ...
    { type: 'h5', size: 28, fw: 400 },
    { type: 'h6', size: 24, fw: 400 },
    { type: 'lead', size: 20, fw: 400 },
    { type: 'body', size: 16, fw: 400 },
    { type: 'small', size: 14, fw: 400 },
  ],
  med: [
    ...
    { type: 'h5', size: 28, fw: 500 },
    { type: 'h6', size: 24, fw: 500 },
    { type: 'lead', size: 20, fw: 500 },
    { type: 'body', size: 16, fw: 500 },
    { type: 'small', size: 14, fw: 500 },
  ],
  bold: [
    ...
    { type: 'h5', size: 28, fw: 700 },
    { type: 'h6', size: 24, fw: 700 },
    { type: 'lead', size: 20, fw: 700 },
    { type: 'body', size: 16, fw: 700 },
    { type: 'small', size: 14, fw: 700 },
  ],
};
